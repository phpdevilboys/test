...
class GmaUser
{
    ...
    /**
     * @var string $secMobileNum
     *
     * @ORM\Column(name="sec_mobile_num", type="string", length=20, nullable=true)
     */
    private $secMobileNum;
     ...
     * Set secMobileNum
     *
     * @param string $secMobileNum
     * @return GmaUser
     */
    public function setSecMobileNum($secMobileNum)
    {
        $this->secMobileNum = $secMobileNum;
        return $this;
    }
     ...
     * @return string 
     */
    public function getSecMobileNum()
    {
        return $this->secMobileNum;
    }
}