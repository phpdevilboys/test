 ...
 */
class ContentTypeRevisions extends \Entities\ContentTypeRevisions implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'contentTypeId', 'authorId', 'authorName', 'revisionDate', 'revisionData');
    }
