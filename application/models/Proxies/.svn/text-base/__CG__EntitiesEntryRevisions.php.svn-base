 ...
 */
class EntryRevisions extends \Entities\EntryRevisions implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'entryId', 'contentTypeId', 'authorId', 'authorName', 'revisionDate', 'revisionData');
    }
